<div class="error">
  <p><?php echo esc_html( K6CP_NAME ); ?> error: Your environment doesn't meet all of the system requirements listed below.</p>
  <ul class="ul-disc">
    <li>
      <strong>PHP <?php echo esc_html( K6CP_REQUIRED_PHP_VERSION ); ?>+</strong>
      <em>(You're running version <?php echo esc_html( PHP_VERSION ); ?>)</em>
    </li>
    <li>
      <strong>WordPress <?php echo esc_html( K6CP_REQUIRED_WP_VERSION ); ?>+</strong>
