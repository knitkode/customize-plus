...
<div class="about-wrap">
	...
	<div class="about-text">
		...
		<ul class="subsubsub" style="margin: 20px 0;">
			<li><a href="https://knitkode.com/"><?php _e( 'Project homepage' ); ?></a> |</li>
			<li><a href="https://knitkode.com/"><?php _e( 'Documentation' ); ?></a> |</li>
			<li><a href="https://knitkode.com/"><?php _e( 'Support forum' ); ?></a> |</li>
			<li><a href="https://knitkode.com/"><?php _e( 'Changelog' ); ?></a> |</li>
	...
	<ul class="kkcp-features">
		...
		<li><i class="dashicons dashicons-media-code"></i>
			...
			<p class="description"><?php _e( 'The documentation makes use of JSdocs and phpdocs.' ); ?> | <a href="https://knitkode.com/">Learn more</a></p>
		</li>
		<li><i class="dashicons dashicons-translation"></i>
			<b><?php _e( 'International' ); ?></b>
			<p class="description"><?php _e( 'If your product has a lot of options you will be able to hide them. And in case, to show them again.' ); ?> | <a href="https://knitkode.com/">Contribute</a></p>
		</li>
	</ul>
</div>