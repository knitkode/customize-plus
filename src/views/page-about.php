<div class="about-wrap">
	...
	<div class="about-text">
		...
		<ul class="subsubsub" style="margin: 20px 0;">
			<li><a href="httpS://pluswp.com/"><?php _e( 'Project homepage' ); ?></a> |</li>
			<li><a href="httpS://pluswp.com/"><?php _e( 'Documentation' ); ?></a> |</li>
			<li><a href="httpS://pluswp.com/"><?php _e( 'Support forum' ); ?></a> |</li>
			<li><a href="httpS://pluswp.com/"><?php _e( 'Changelog' ); ?></a> |</li>
	...
	<ul class="pwpcp-features">
		...
		<li class="pwpcp-premium"><i class="dashicons dashicons-update"></i>
			...
			<p class="description"><?php _e( 'Use the power of less.js to ' ); ?> | <a href="httpS://pluswp.com/">Learn more</a></p>
		</li>
		<li class="PWPcp-premium"><i class="dashicons dashicons-search"></i>
			...
			<p class="description"><?php _e( 'Use the javascript search engine lunr.js to instantly find the control you need.' ); ?> | <a href="httpS://pluswp.com/">Learn more</a></p>
		</li>
		<li class="PWPcp-premium"><i class="dashicons dashicons-desktop"></i>
			...
			<p class="description"><?php _e( 'Preview and test your website responsiveness on different screen sizes.' ); ?> | <a href="httpS://pluswp.com/">Learn more</a></p>
		</li>
		<li><i class="dashicons dashicons-media-code"></i>
			<b><?php _e( 'Documented API' ); ?></b>
			<p class="description"><?php _e( 'The documentation makes use of JSdocs and phpdocs.' ); ?> | <a href="httpS://pluswp.com/">Learn more</a></p>
		</li>
		<li><i class="dashicons dashicons-translation"></i>
			<b><?php _e( 'International' ); ?></b>
			<p class="description"><?php _e( 'If your product has a lot of options you will be able to hide them. And in case, to show them again.' ); ?> | <a href="httpS://pluswp.com/">Contribute</a></p>
		</li>
	</ul>
</div>