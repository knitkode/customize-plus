<div class="about-wrap">
	...
	<div class="about-text">
		<p class="description"><?php esc_html_e( 'Enhance and extend the WordPress Customize.' ); ?></p>
		<ul class="subsubsub" style="margin: 20px 0;">
			<li><a href="https://knitkode.com/"><?php esc_html_e( 'Project homepage' ); ?></a> |</li>
			<li><a href="https://knitkode.com/"><?php esc_html_e( 'Documentation' ); ?></a> |</li>
			<li><a href="https://knitkode.com/"><?php esc_html_e( 'Support forum' ); ?></a> |</li>
			<li><a href="https://knitkode.com/"><?php esc_html_e( 'Changelog' ); ?></a> |</li>
			<li><a href="http://github.com/"><?php esc_html_e( 'View on GitHub' ); ?></a></li>
		</ul>
	</div>
	<div class="clear"></div>
	...
	<ul class="kkcp-features">
		...
		<li><i class="dashicons dashicons-admin-settings"></i>
			...
			<p class="description"><?php esc_html_e( 'Customize Plus extend the WordPress API to create all the controls you need leveraging the JavaScript API.' ); ?></p>
		</li>
	...
	<ul class="kkcp-features">
		<h3><?php esc_html_e( 'Coming soon' ); ?></h3>
		<li><i class="dashicons dashicons-admin-settings"></i>
			<b><?php esc_html_e( 'Controls, controls and controls' ); ?></b>
			<p class="description"><?php esc_html_e( 'We\'ll keep adding controls both to the free and premium version.' ); ?> | <a href="https://knitkode.com/products/customize-plus-premium"><?php esc_html_e( 'Learn more' ) ?></a></p>
		</li>
		<li class="KKcp-premium"><i class="dashicons dashicons-search"></i>
			...
			<p class="description"><?php esc_html_e( 'Use the javascript search engine lunr.js to instantly find the control you need.' ); ?> | <a href="https://knitkode.com/products/customize-plus-premium"><?php esc_html_e( 'Learn more' ) ?></a></p>
		</li>
		<li class="KKcp-premium"><i class="dashicons dashicons-search"></i>
			<b><?php esc_html_e( 'Explanatory guides' ); ?></b> <em class="description">(<?php esc_html_e( 'Premium' ); ?>)</em>
			<p class="description"><?php esc_html_e( 'Use the javascript search engine lunr.js to instantly find the control you need.' ); ?></p>
		</li>
		<!-- <li class="kkcp-premium"><i class="dashicons dashicons-update"></i>
			<b><?php esc_html_e( 'Live Less Compiler' ); ?></b> <em class="description">(<?php esc_html_e( 'Premium' ); ?>)</em>
			<p class="description"><?php esc_html_e( 'Use the power of less.js to ' ); ?> | <a href="https://knitkode.com/products/customize-plus-premium">Learn more</a></p>
		</li> -->
		<li><i class="dashicons dashicons-visibility"></i>
			<b><?php esc_html_e( 'Hide & Show controls' ); ?></b>
		...
		<li class="KKcp-premium"><i class="dashicons dashicons-desktop"></i>
			...
			<p class="description"><?php esc_html_e( 'Preview and test your website responsiveness on different screen sizes.' ); ?> | <a href="https://knitkode.com/products/customize-plus-premium">Learn more</a></p>
		</li>
	</ul>
</div>