	...
	class K6CP_Customize_Compiler {
		...
		public static function add_to_js_constants() {
			return array(
				...
				'WORKER_URL' => K6CP::$_ASSETS . 'customize-worker.min.js',
				'UNCOMPILED_STYLESHEET_URL' => K6CP::$_ASSETS . 'styles/',
				...
				'PREPROCESSOR_URL' => K6CP::$_ASSETS . 'less.min.js',
				'PREPROCESSOR_WORKER_URL' => K6CP::$_ASSETS . 'less-worker.min.js',
