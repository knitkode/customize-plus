	...
	class KKcp {
		...
		public static function meta_links( $links, $file ) {
			...
			if ( $file === plugin_basename( KKCP_PLUGIN_FILE ) ) {
				unset( $links[2] );
				$links[] = '<a href="https://knitkode.com/products/customize-plus" target="_blank">' . esc_html__( 'Project homepage', 'kkcp' ) . '</a>';
				$links[] = '<a href="https://knitkode.com/support" target="_blank">' . esc_html__( 'Support', 'kkcp' ) . '</a>';
				$links[] = '<a href="http://wordpress.org/extend/plugins/customize-plus/changelog/" target="_blank">' . esc_html__( 'Changelog', 'kkcp' ) . '</a>';
			}
			return $links;
		}
